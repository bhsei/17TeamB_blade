...
import static com.blade.kit.reflect.ConvertKit.bytes2HexString;
import static com.blade.kit.reflect.ConvertKit.hexString2Bytes;
...
public class EncrypKit {
	...
	public static byte[] encryptDES2Base64(byte[] data, byte[] key) {
		return EncodeKit.base64Encode(encryptDES(data, key));
	}
	...
	public static byte[] decryptBase64DES(byte[] data, byte[] key) {
		return decryptDES(EncodeKit.base64Decode(data), key);
	}
	...
	public static byte[] encrypt3DES2Base64(byte[] data, byte[] key) {
		return EncodeKit.base64Encode(encrypt3DES(data, key));
	}
	...
	public static byte[] decryptBase64_3DES(byte[] data, byte[] key) {
		return decrypt3DES(EncodeKit.base64Decode(data), key);
	}
	...
	public static byte[] encryptAES2Base64(byte[] data, byte[] key) {
		return EncodeKit.base64Encode(encryptAES(data, key));
	}
	...
	public static byte[] decryptBase64AES(byte[] data, byte[] key) {
		return decryptAES(EncodeKit.base64Decode(data), key);
	}
